...
extern "C" void* Prtc_dtor(void* this_, short how) {
    if (this_) {
        *(void**)this_ = lbl_804A9AC8;
        void* h0 = *(void**)((char*)this_ + 0x234);
        if (h0) {
            fn_801EE434(h0);
        }
        void* h1 = *(void**)((char*)this_ + 0x238);
        if (h1) {
            fn_801EE434(h1);
        }
        void* h2 = *(void**)((char*)this_ + 0x23c);
        if (h2) {
            fn_801EE434(h2);
        }
