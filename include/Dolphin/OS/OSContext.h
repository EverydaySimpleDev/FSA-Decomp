...
// The context currently holding live FPU register state, if any (same
// fixed kernel address zeldaret/tww's real Dolphin SDK source uses,
// confirmed via src/dolphin/os/OSContext.c's OS_CURRENT_FPU_CONTEXT).
